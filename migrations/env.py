...
The URL is never hard-coded here: it is derived from the same Settings object the
application uses, so migrations can never drift onto a different database.
"""
